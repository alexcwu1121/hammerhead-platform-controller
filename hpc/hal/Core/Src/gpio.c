...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, P_M2_EN_Pin|P_SPARE_GPIO_2_Pin|P_SPARE_GPIO_3_Pin|P_SPARE_GPIO_4_Pin
                          |P_SPARE_GPIO_5_Pin|P_M1_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : P_M2_EN_Pin P_SPARE_GPIO_2_Pin P_SPARE_GPIO_3_Pin P_SPARE_GPIO_4_Pin
                           P_SPARE_GPIO_5_Pin P_M1_EN_Pin */
  GPIO_InitStruct.Pin = P_M2_EN_Pin|P_SPARE_GPIO_2_Pin|P_SPARE_GPIO_3_Pin|P_SPARE_GPIO_4_Pin
                          |P_SPARE_GPIO_5_Pin|P_M1_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
